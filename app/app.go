...
import (
	...
	"github.com/vidulum/vidulum/app/openapi"
	"github.com/vidulum/vidulum/docs"

	vidulummodule "github.com/vidulum/vidulum/x/vidulum"
	vidulummodulekeeper "github.com/vidulum/vidulum/x/vidulum/keeper"
	vidulummoduletypes "github.com/vidulum/vidulum/x/vidulum/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "vdl"
	Name                 = "vidulum"
)
...
type App struct {
	*baseapp.BaseApp
	...
	VidulumKeeper vidulummodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		vidulummoduletypes.StoreKey, burnermoduletypes.StoreKey,
	...
	app.VidulumKeeper = *vidulummodulekeeper.NewKeeper(
		appCodec,
		keys[vidulummoduletypes.StoreKey],
		keys[vidulummoduletypes.MemStoreKey],
	)
	vidulumModule := vidulummodule.NewAppModule(appCodec, app.VidulumKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		vidulummoduletypes.ModuleName, vestingtypes.ModuleName, burnermoduletypes.ModuleName,
	)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(vidulummoduletypes.ModuleName)
